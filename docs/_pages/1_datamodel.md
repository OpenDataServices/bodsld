...
![The UnspecifiedReason class and its subclasses (from the codelist)](/assets/diagrams/unspecifiedreason.png){:.small}
...
>
> **[See issue](https://github.com/openownership/issues/2)**.
{: .block-danger }
...
![Agent class with two properties](/assets/diagrams/agent.png){:.small}
...
![Jurisdiction and its two properties](/assets/diagrams/jurisdiction.png){:.small}
